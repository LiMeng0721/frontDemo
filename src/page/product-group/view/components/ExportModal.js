...
import { exportFile, filterNullElement, RadioGroup } from "yss-trade-base";
@Form.create()
class ExportModal extends Component {
    ...
    exportCurent = (values) => {
        const { url, search, name } = this.props;
        console.log(search);
        exportFile(url, { exportType: values.exportType, ...filterNullElement(search) }, name, false);
    };
    // 导出选中
